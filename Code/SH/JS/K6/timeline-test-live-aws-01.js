...
export default function() {
    ...
    postSaveLogs(res, timeline_api, latencyMetric);
...
function postSaveLogs(res, timeline_api, latencyMetric) {
    ...
    res = http.post(timeline_api + "/v"+ version + "/gym_logs/save/"+"gym_id=401&message=settimerupdate-true-1414559305463-false-0&screen=0&sent_at=", formdata, { headers: headers });
